...
#                 # ✅ AGREGAR: Cargar ISO_value si existe
...
#                 proceso_lugar_map = {}
#                 for fila in contenido:  # Asumiendo que tienes acceso a esta tabla
#                     proceso = fila[0]
#                     lugar = fila[2]
#                     proceso_lugar_map[proceso] = lugar
                        
#                     context = {
#                         'procesos': procesos,
#                         'lugares': lugares,
#                         'proceso_lugar_json': json.dumps(proceso_lugar_map)  # Convertir a JSON
#                     }
...
#                 "iso_values": json.dumps(iso_values_normalized),
#                 "context": context,
#             }
#         )
#     else:
